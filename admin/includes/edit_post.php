...
<form action="" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label for="posts_status">Posts status</label>
		<input type="text" name="posts_status" class="form-control" value="<?php echo $post_status; ?>">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<label for="posts_tags">Posts Tags</label>
		<input type="text" name="posts_tags" class="form-control" value="<?php echo $post_tags; ?>">
	</div>
	<div class="form-group">
